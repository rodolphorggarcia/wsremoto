...
public class Slide77Exercicio4 {
	...
	public static void main(String[] args) {
		...
		System.out.println("O numero de maiores de idade é: "+ contadorMaiores);
		System.out.printf("A media das idades é %.2f: \n", media/contador);
		System.out.println("A maior idade é: "+ maiorIdade + " - " + nomeMaiorIdade);
		System.out.println("A menor idade é: "+ menorIdade + " - " + nomeMenorIdade);
	}
}
